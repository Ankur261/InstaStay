    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "RoomId", "PricePerDay", "RoomNumber", "Status", "Type" },
                values: new object[,]
                {
                    { 1, 100.00m, "101", "Available", "Single" },
                    { 2, 150.00m, "102", "Available", "Double" },
                    { 3, 250.00m, "201", "Available", "Deluxe" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "reception123", "Receptionist", "reception" }
                });
